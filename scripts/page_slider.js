var slider = function (sliderElement) {
  ...
  // Обработчики для канваса
  if (canvas) {
    canvas.addEventListener("mouseenter", () => (isOverCanvas = true));
    canvas.addEventListener("mouseleave", () => (isOverCanvas = false));
  ...
  var init = function () {
    ...
    sidebarButton.id = "sidebar_button";
    sidebarButton.src = "./img/list.png";
    sidebarButton.classList.add("button");

    let downButton = document.createElement("img");
    downButton.id = "down_button";
    downButton.src = "./img/down-arrow.png";
    downButton.classList.add("button");

    let upButton = document.createElement("img");
    upButton.id = "up_button";
    upButton.src = "./img/down-arrow.png";
    upButton.classList.add("button");
    upButton.classList.add("button_reversed");
